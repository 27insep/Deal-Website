...
<div>
	...
	<table cellpadding="0" cellspacing="1" border="0" class="display" id="show_data" width="100%">
		...
		<? 
		$i=0;
		foreach($deal_sell_data as $data){?>
		<tr>
			...
			<td align="center"><?=number_format($data["summary"])?></td>
			<td align="center"><a href="/mybackoffice/show_product_sell/<?=$data["deal_id"]?>" target="_blank"><?=image_asset('/icon/info.png', '', array('alt'=>'รายละเอียด','title'=>'รายละเอียด'));?></a></td>
			<td><?=$data["vendor_status"]?></td>
			<td><?=$data["vendor_id"]?></td>
			<td align="center"><?=$data["summary"]?></td>
