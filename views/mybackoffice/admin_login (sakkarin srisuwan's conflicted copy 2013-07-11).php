...
<form name="admin_login_form" id="admin_login_form" method="post" action="/mybackoffice/admin_login">
	...
	<div id="admin_login_detail">
		<div id="admin_user"><div class="admin_user_txt">Username</div><input type="text" name="admin_username" id="admin_username" value="" size="41"/></div>
		<div id="admin_pwd"><div class="admin_user_txt">Password</div><input type="password" name="admin_password" id="admin_password" value="" size="41"/></div>
