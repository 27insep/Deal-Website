<div id="how2pay_box">
	<div id="how2pay_account">
		<div>Bank Name: ธนาคารไทยพาณิชย์</div>
		<div>
        	Account holder: THE BEST DEAL CO., LTD.<br />
            หมายเลขบัญชี:   206-3-002-653<br />
            Service Code : BESTDEAL
        </div>
	</div>
	<? if(!isset($not_show_detail)){?>
	<div>รายละเอียด :</div>
	<div id="how2pay_logo">
		<?echo image_asset('bank_logo/scb_logo.jpg');?>
	</div>
	<div class="clear">
		<br/>
		<div>เนื่องจากบริษัท เดอะ เบสท์ ดีล จำกัด ได้ปรับปรุงระบบการชำระเงินผ่าน ธนาคารไทยพาณิชย์โดยสามารถเลือกชำระผ่าน 3 ช่องทางดังต่อไปนี้</div>
		<br/>
		<div>
		<ul>
  			<li>ATM   **  ดูรายละเอียดเพิ่มเติม <a target="_blank" href="/assets/media/bank_payment/scb_bp_via_atm.pdf">คลิกที่นี่</a></li>
  			...
  			<li>SCB Easy Net อินเทอร์เน็ต    **  ดูรายละเอียดเพิ่มเติม <a target="_blank" href="/assets/media/bank_payment/scb_bp_via_easy_net.pdf">คลิกที่นี่</a></li>
		</ul>
		</div>
		<br/>
		<div>เงื่อนไข :</div>
