<div id="cart_detail">
    ...
    <div id="main_cart" class="o">
        ...
        <div id="pay_solution">
        	...
        	<?if($test==1){?>
        		<div><input type="radio" name="how2pay" id="how2pay_cs" value="5" onclick="load_how2pay(8)"/>ชำระเงินผ่านบัตรเครดิต</div>
        	<? } ?>
 				...
 				$( "#dialog" ).dialog(
 					{ 
 						...
 						close: function( event, ui ) 
 						{
							...
							if(payment_type==3){
								window.location.href = '/shopping/krungsri_credit/'+responseText;
							}
 						},
