...
<div id="vendor_main">
	...
	<div class="clear">
		<div id="vender_over_view" class="ven_dor_tab_menu current" onclick="load_box()">เคมเปญ</div>
		<div id="vender_voucher" class="ven_dor_tab_menu hidebox" onclick="load_voucher()">Voucher</div>
	</div>
